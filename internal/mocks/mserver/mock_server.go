...
//
//	mockgen -destination=./mserver/mock_server.go -package=mserver go-micro.dev/v5/server Server,Request,Message
//
...
func (mr *MockServerMockRecorder) Handle(arg0 any) *gomock.Call {
...
func (mr *MockServerMockRecorder) Init(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockServer) NewHandler(arg0 any, arg1 ...server.HandlerOption) server.Handler {
	m.ctrl.T.Helper()
	varargs := []any{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (mr *MockServerMockRecorder) NewHandler(arg0 any, arg1 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockServer) NewSubscriber(arg0 string, arg1 any, arg2 ...server.SubscriberOption) server.Subscriber {
	m.ctrl.T.Helper()
...
func (mr *MockServerMockRecorder) NewSubscriber(arg0, arg1 any, arg2 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServerMockRecorder) Subscribe(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
