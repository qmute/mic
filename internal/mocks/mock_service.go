...
//
//	mockgen -destination=mock_service.go -package=mocks go-micro.dev/v5 Service
//
...
import (
	...
	service "go-micro.dev/v5/service"
...
func (m *MockService) Handle(arg0 any) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Handle(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Handle", reflect.TypeOf((*MockService)(nil).Handle), arg0)
}

// Init mocks base method.
func (m *MockService) Init(arg0 ...service.Option) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
...
func (m *MockService) Options() service.Options {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Options")
	ret0, _ := ret[0].(service.Options)
	return ret0
}
